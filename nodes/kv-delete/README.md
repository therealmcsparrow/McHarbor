...
Delete a value from the workflow key-value store
...
This frontend node is bound to the workflow action key `kv-delete` in `src/backend/modules/workflows/service.go`.
Category: `utility`.
