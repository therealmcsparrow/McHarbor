...
- `Working Directory` (text, optional): Single-line text value.
...
This frontend node is bound to the workflow action key `container-exec` in `src/backend/modules/workflows/service.go`.
Category: `action`.
