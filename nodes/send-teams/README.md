...
Send a message to a Microsoft Teams webhook
...
- `Color` (text, optional): Single-line text value.
...
This frontend node is bound to the workflow action key `send-teams` in `src/backend/modules/workflows/service.go`.
