...
Map array object keys to a new shape
...
- `Mapping` (key-value, optional): Build an object as key/value pairs.
...
This frontend node is bound to the workflow action key `map` in `src/backend/modules/workflows/service.go`.
Category: `utility`.
