...
Load Docker daemon information from an environment
...
This frontend node is bound to the workflow action key `docker-info` in `src/backend/modules/workflows/service.go`.
Category: `action`.
