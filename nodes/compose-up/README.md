...
Start containers that belong to a compose stack
...
This frontend node is bound to the workflow action key `compose-up` in `src/backend/modules/workflows/service.go`.
Category: `action`.
