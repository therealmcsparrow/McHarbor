...
import {
  ...
  IconClipboardList, IconSettings, IconRefresh, IconInfoCircle,
      ...
      >
        <Command className="flex flex-col">
          ...
          <Command.List className="max-h-80 overflow-y-auto p-2">
            ...
            <Command.Group heading={t('nav.navigation')} className="px-2 py-1 text-xs font-medium text-muted-foreground">
              {commands.map((cmd) => {
