...
Read one-shot runtime metrics for a container
...
This frontend node is bound to the workflow action key `container-stats` in `src/backend/modules/workflows/service.go`.
Category: `action`.
