...
- `Seconds` (number, optional): Numeric value. Default: `1`.
...
This frontend node is bound to the workflow action key `delay` in `src/backend/modules/workflows/service.go`.
Category: `utility`.
