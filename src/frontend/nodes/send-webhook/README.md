...
Send an outbound webhook with message data
...
This frontend node is bound to the workflow action key `send-webhook` in `src/backend/modules/workflows/service.go`.
