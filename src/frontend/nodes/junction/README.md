...
Create a simple routing point on the canvas
...
This frontend node is bound to the workflow action key `junction` in `src/backend/modules/workflows/service.go`.
Category: `utility`.
