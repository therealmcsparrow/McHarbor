...
Read a file from the workflow data directory
...
This frontend node is bound to the workflow action key `read-file` in `src/backend/modules/workflows/service.go`.
Category: `utility`.
