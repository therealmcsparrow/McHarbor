...
Search a container registry for images
...
This frontend node is bound to the workflow action key `registry-search` in `src/backend/modules/workflows/service.go`.
Category: `action`.
