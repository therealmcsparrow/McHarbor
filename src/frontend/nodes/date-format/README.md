...
Parse and reformat a date or timestamp
...
- `Output Format` (text, optional): Single-line text value. Default: `2006-01-02T15:04:05Z07:00`.
...
This frontend node is bound to the workflow action key `date-format` in `src/backend/modules/workflows/service.go`.
Category: `utility`.
