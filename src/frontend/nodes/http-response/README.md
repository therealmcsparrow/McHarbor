...
Set the outgoing status code and headers on the message
...
This frontend node is bound to the workflow action key `http-response` in `src/backend/modules/workflows/service.go`.
Category: `utility`.
