...
Start a workflow manually from the editor or run panel
...
This frontend node is bound to the workflow action key `manual-trigger` in `src/backend/modules/workflows/service.go`.
Category: `trigger`.
