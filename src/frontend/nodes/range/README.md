...
Read an array property and attach range metadata
...
This frontend node is bound to the workflow action key `range` in `src/backend/modules/workflows/service.go`.
Category: `logic`.
