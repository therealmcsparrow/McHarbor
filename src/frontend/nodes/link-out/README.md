...
Store the current message for another workflow to consume
...
This frontend node is bound to the workflow action key `link-out` in `src/backend/modules/workflows/service.go`.
Category: `utility`.
