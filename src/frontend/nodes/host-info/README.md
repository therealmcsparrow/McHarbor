...
Read host information from a Docker environment
...
This frontend node is bound to the workflow action key `host-info` in `src/backend/modules/workflows/service.go`.
Category: `action`.
