...
VALUES
    ('role_admin', 'Admin', 'Full access to all resources and settings', '["*"]', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO user_roles (id, user_id, role_id, environment_id, created_at, updated_at)
SELECT
    'ur_first_admin',
    u.id,
    'role_admin',
