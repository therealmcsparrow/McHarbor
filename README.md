...
The default production compose file pulls `ghcr.io/therealmcsparrow/mcharbor:1.1.20-dev`. To run the optional remote agent from Compose, set `MCHARBOR_URL` and `MCHARBOR_AGENT_TOKEN` and start the `agent` profile:
